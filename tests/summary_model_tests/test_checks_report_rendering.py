        ...
        _check_result(
            ...
            details={
                "internal_differences": [
                    "В ПГ в поле «Сроки поставки товара, выполнения работ, оказания услуг по контракту» перечислены этапы 1, 2, 3.",
                    "В ПГ в поле «Этапы исполнения контракта» предусмотрено 2 этапа: 1, 2.",
                    "Это явное внутреннее противоречие ПГ: в сроках указано 3 этапа, а в таблице этапов — 2.",
                ],
...
def test_report_renders_commercial_offer_comparison_as_one_compact_table():
    ...
    assert "| Позиция | ОНМЦК №1 | КП №1 | ОНМЦК №2 | КП №2 | ОНМЦК №3 | КП №3 | Статус |" in text
    assert "| Сервер | 10300000.00 × 4 шт. | 10300000.00 × 4 шт. | 10470000.00 × 4 шт. | 10470000.00 × 4 шт. | 10245000.00 × 4 шт. | 10245000.00 × 4 шт. | ОК |" in text
